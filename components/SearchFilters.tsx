...
import { PlayerFilters, Position, DealStatus, PreferredFoot, Sport, ProfileRole } from '../types';
            ...
            >
                <Row gutter={[16, 12]} align="middle" style={{ paddingTop: 4 }}>
                    <Col xs={24} lg={expanded ? 18 : 20}>
                        <Input
                            size="large"
                            className="bg-white border-none shadow-sm h-12 md:h-14 text-base md:text-lg rounded-xl px-4 md:px-6 focus:ring-2 focus:ring-[#3F3F3F] hover:shadow-md transition-all"
                    ...
                    <Col xs={24} lg={expanded ? 6 : 4}>
                        <Row gutter={12} justify={{ xs: 'start', lg: 'end' }} align="middle">
                            <Col flex="auto" className="lg:flex-initial">
                                <Badge count={activeCount} offset={[-4, 4]} color="#3F3F3F" className="w-full lg:w-auto">
                                    <Button
                                        size="large"
                                        icon={<FilterOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
                                        onClick={() => setExpanded(!expanded)}
                                        className={`h-12 md:h-14 px-6 rounded-xl border-0 shadow-sm transition-all w-full ${expanded ? 'bg-[#3F3F3F] text-white shadow-lg' : 'bg-white text-[#C9A24D] font-bold hover:bg-slate-50'}`}
                        ...
                        <Row gutter={[24, 24]}>
                            ...
                            <Col xs={24} sm={12} lg={8}>
                                <Space direction="vertical" size="large" className="w-full">
                                    <div>
                                        <FilterLabel icon={<UserOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />} label={t('common.role')} />
                                        <Select
                                            mode="multiple"
                                            placeholder={t('common.role')}
                                            className="w-full custom-select"
                                            value={filters.role}
                                            onChange={(v) => onChange({ ...filters, role: v as ProfileRole[] })}
                                            allowClear
                                            maxTagCount="responsive"
                                        >
                                            <Option value={ProfileRole.PLAYER}>{t('common.player')}</Option>
                                            <Option value={ProfileRole.COACH}>{t('common.coach')}</Option>
                                        </Select>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="px-2">
                                            <Slider
                                                ...
                                                className="custom-slider"
                                            />
                                            <div className="flex justify-between text-[11px] font-bold text-[#3F3F3F]">
